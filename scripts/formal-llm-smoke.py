#!/usr/bin/env python3
"""
Formal path B + DeepSeek LLM smoke.

Requires:
  - Server with werewolf.ai.enabled=true and DEEPSEEK_API_KEY
  - pip install requests websocket-client

Outputs JSON report to scripts/reports/ (and stdout summary).

Env:
  WEREWOLF_BASE_URL, WEREWOLF_WS_URL
  WEREWOLF_SMOKE_TICKS (default 800)
  WEREWOLF_TICK_TIMEOUT (default 120, seconds per phase-tick HTTP call)
"""
