#!/usr/bin/env python3
"""Observe PHASE_SYNC.countdown over WS (Formal path B, ~30s).

P-05 acceptance script. Behavior and formal-path-smoke caveat:
docs/reference/gateway-integration.md §6
"""
