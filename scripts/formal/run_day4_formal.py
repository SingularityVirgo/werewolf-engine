#!/usr/bin/env python3
"""
PRD §8.2 Day4 — Formal 路径 B：12 Bot 同房联调验收。

路径: scripts/formal/run_day4_formal.py
作用: 验证 WS 连接、JOIN/PHASE_SYNC、start、狼座 ACTION_ACK、phase-tick 终局；可选双房隔离。
...
环境:
  WEREWOLF_BASE_URL, WEREWOLF_WS_URL, WEREWOLF_BOT_STAGGER, WEREWOLF_MAX_TICKS
"""
...
from lib.auto_action import maybe_auto_action
from lib.bot_player import BotPlayer
from lib.config import default_config
from lib.http_api import HttpApiClient
from lib.message_handler import safe_print
