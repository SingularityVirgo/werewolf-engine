#!/usr/bin/env python3
"""
Internal 路径 A：逐步 phase-tick 推进对局（模拟网关定时器）。

路径: scripts/internal/tick_play_client.py
作用: 循环 POST phase-tick 直至 GAME_OVER 或 STUCK。

用法:
  python scripts/internal/tick_play_client.py
  python scripts/internal/tick_play_client.py --room-id <id>
"""
