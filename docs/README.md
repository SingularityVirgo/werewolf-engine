...
| **[progress/mvp-signoff-2026-05-27.md](progress/mvp-signoff-2026-05-27.md)** | **PRD v1.0.17 MVP 签字记录** |
...
| **参考** | 见下表 | 包结构、联调、鉴权、测试 |
| **执行清单** | [gateway-room-ws](checklists/gateway-room-ws.md) | B 侧勾选（非架构真源） |
...
| **[007](adr/007-persistence-redis-mysql.md)** | **MySQL / Redis 持久化、断线重连** |
...
| [persistence-rollout.md](reference/persistence-rollout.md) | A、B | 阶段 checklist → **[ADR-007](adr/007-persistence-redis-mysql.md)** |
...
| **B（gateway）** | [status](progress/status.md) → PRD §4.2、§4.6～4.7、§8.5 → **[ADR-005](adr/005-gateway-formal-path.md)** → **[ADR-007](adr/007-persistence-redis-mysql.md)** → [gateway-room-modules](reference/gateway-room-modules.md) → [gateway-integration](reference/gateway-integration.md) → [checklist](checklists/gateway-room-ws.md) |
