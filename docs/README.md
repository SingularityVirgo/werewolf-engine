...
| **需求** | [requirements-mvp-v0.1.md](progress/requirements-mvp-v0.1.md) | MVP v1.0.15；§8.5 实现对照（非冻结） |
...
| **C（bot）** | [status](progress/status.md) → [gateway-integration](reference/gateway-integration.md) → [bot-load-test](reference/bot-load-test.md) → [bot/README](../bot/README.md) |
